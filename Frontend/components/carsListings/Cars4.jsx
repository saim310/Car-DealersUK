...
export default function Cars4() {
  ...
  // 2. Main Filtering Logic (Now using liveCars)
  useEffect(() => {
    if (!liveCars) return;
  ...
  if (loading)
    return <div className="text-center py-5">Loading Map & Listings...</div>;
      ...
      <div className="wrap-map flat-featured listing-grid style flex listing-wrap-map">
          ...
          <div className="category-filter flex justify-space align-center mb-30 flex-wrap gap-20">
            <div className="box-1">
              <h2 className="heading-listing">
                {sorted.length} Vehicles Near You
              </h2>
            </div>
          ...
          >
            {sorted.length ? (
              ...
              <div className="fs-16 p-4">
                No vehicles match your current map view or filters.
              </div>
            )}
          </div>
        ...
        <div className="content-right fixed-space po-sticky">
          <div id="map" className="row-height">
            {/* Pass current filtered cars to the map to show pins */}
