...
import { ALLOWED_BODY_TYPES } from "@/utils/exports";
        ...
        <div className="form-filter-siderbar">
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="form-group">
              <input
                type="text"
                placeholder="Search by keywords or plate number"
                value={allProps.search}
                onChange={(e) => allProps.setSearch(e.target.value)}
            ...
            <div className="wd-find-select">
              ...
              <div className="form-group">
                <div className="group-select">
                  <DropdownSelect
                    ...
                    options={allProps.modelOptions || ["Any Model", "A4", "Almera", "Carnival"]}
                  />
                </div>
              </div>
              <div className="form-group">
                <div className="group-select">
                  <DropdownSelect
                    ...
                    options={["Any Body", ...ALLOWED_BODY_TYPES]}
                  />{" "}
                </div>
              </div>
              ...
              <div className="form-group wg-box3">
                <div className="widget widget-price">
                  <div className="caption flex-two">
                    <div>
                      <span className="fw-6">
                        Miles: {(allProps.km?.[0] ?? 0).toLocaleString()} – {(allProps.km?.[1] ?? 500000).toLocaleString()} Miles
                      </span>
                    </div>
                  </div>
                  <Pricing
                    MIN={0}
                    MAX={500000}
                    priceRange={allProps.km || [0, 500000]}
                ...
                <div className="form-group">
                  <div className="tf-amenities bg-white">
                    {featureOptions.map((feature, index) => (
                      <label className="flex-three" key={index} style={{ cursor: "pointer" }}>
                        <input
              ...
              <div className="form-group">
                <div className="group-select">
                  <DropdownSelect
                    selectedValue={allProps.sortingOption}
              ...
              <div className="form-group">
                <div className="group-select">
                  <DropdownSelect
                    selectedValue={`Show: ${allProps.itemPerPage}`}
                    onChange={(v) =>
