...
import SoldListingModal from "./SoldListingModal";
...
export default function DashBoard() {
  ...
  useEffect(() => {
    console.log(listings, "listings in dashboard");
  ...
  const handleOpenSoldModal = (listing) => {
    console.log("🛑 Sold button clicked for listing:", listing);
                        ...
                        <div className="card-body">
                          ...
                          <div className="content-overview">
                            ...
                            <div className="tfcl-dashboard-title">
                              <span>
                                <b>
                                  {pendingListings.toString().padStart(2, "0")}
                                </b>
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="col-xl-3 col-lg-6 mb-2">
                            <div className="group-input-icon search">
                              <input
                                ...
                                placeholder="Search by title, model, brand, or plate..."
                              />
                        ...
                        <div className="tfcl-table-listing">
                          <div className="table-responsive">
                            <span className="result-text">
                              <b>{filteredListings.length}</b> results found
                            </span>
                            <table className="table">
                              ...
                              <tbody className="tfcl-table-content">
                                {loading ? (
                                  ...
                                  <tr>
                                    <td colSpan="4" className="text-center">
                                      {searchText ? "No listings match your search" : "No listings found"}
                                    </td>
                                  </tr>
                                ) : (
                                  filteredListings.map((elm, i) => (
                                    <tr key={i}>
                                      ...
                                      <td className="column-controller">
                                        <div className="inner-controller">
                                          ...
                                          <Link
                                            href={`/add-listing?id=${elm.id}&edit=true`}
                                        ...
                                        <div className="inner-controller">
                                          ...
                                          <button
                                            type="button"
                                            className="btn-action tfcl-dashboard-action-edit"
                                            onClick={() => handleOpenSoldModal(elm)}
