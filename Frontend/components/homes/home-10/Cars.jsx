...
import useFetch from "@/hooks/useFetch"; // 1. Import dynamic fetch hook
...
export default function Cars() {
  ...
  // 3. Map the backend data when it arrives
  useEffect(() => {
    if (backendListings) {
        ...
        imgSrc:
          item.images && item.images.length > 0
            ? item.images[0].startsWith("/uploads")
              ...
              ? `https://apis.ukaautotrade.co.uk${item.images[0]}`

       

              : item.images[0]
            : "/assets/images/car-list/car1.jpg",
  ...
  // 4. Filter the live data when the tab changes
  useEffect(() => {
    if (selectedType === "All") {
      setFiltered(dynamicCars);
    } else {
      setFiltered(dynamicCars.filter((el) => el.type === selectedType));
    }
  }, [selectedType, dynamicCars]);
                ...
                <div className="content-inner tab-content">
                  {loading ? (
                    <p style={{ textAlign: "center", padding: "20px" }}>
                      Loading searched cars...
                    </p>
                  ) : filtered.length === 0 ? (
                    <p style={{ textAlign: "center", padding: "20px" }}>
                      No {selectedType !== "All" ? selectedType : ""} cars
                      found.
                    </p>
                  ) : (
                    <>
                      ...
                      >
                                ...
                                {/* <div className="days-box flex justify-space align-center">
                                  {/* <div className="img-author">
                                    <Image
                                      ...
                                      alt={car.authorName}
                                      src={car.authorImage}
                                      width={40} // Resized avatar to fit properly
                                      height={40}
                                      style={{
                                        borderRadius: "50%",
                                        objectFit: "cover",
                        ...
                        <div className="swiper-pagination5 spd11 pb-1"></div>
                      </Swiper>
