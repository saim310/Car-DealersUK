...
export default function Cars2() {
  ...
  const swiperOptions = {
    ...
    // },
    loop: dynamicCars.length > 2, // Only loop if there are enough items to not break the swiper layout
    slidesPerView: 1,
    spaceBetween: 30,
    navigation: {
      clickable: true,
                          ...
                          <div className="content">
                            ...
                            <div className="icon-box flex flex-wrap">
                              <div className="icons flex-three">
                                ...
                                <span>{kmToMiles(elm.km).toLocaleString()} Miles</span>
                              </div>
                              <div className="icons flex-three">
