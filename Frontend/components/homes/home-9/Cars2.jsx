...
const priceRanges = [
  { title: "All used cars", isActive: true, range: null }, // Adjusted title slightly for clarity
  {
    title: "$50.000 - $80.000",
    isActive: false,
...
export default function Cars2() {
  ...
  // 4. Filter the live data when the budget tab changes
  useEffect(() => {
                  ...
                  {priceRanges.map((item, index) => (
                    <li
                      ...
                      className={`item-title ${
                        item.title === selectedRange.title ? "active" : ""
                      }`}
              ...
              <div className="content-tab">
                <div className="content-inner tab-content">
                  {loading ? (
                    ...
                    <p style={{ textAlign: "center", padding: "20px" }}>
                      No cars found in this budget range.
                    </p>
                  ) : (
                    <>
                      <Swiper
                            ...
                            <div className="box-car-list hv-one">
                              <div className="image-group relative">
                                <div className="top flex-two">
                                  ...
                                  {/* Fixed Hardcoded 2024 to use actual car year */}
                                ...
                                {/* <div className="days-box flex justify-space align-center">
                                  {/* <div className="img-author">
                                    <Image
                                      ...
                                      alt={car.authorName}
                                      src={car.authorImage}
                                      width={40} // Scaled author image down to 40
                                      height={40}
                                      style={{
                                        borderRadius: "50%",
                                        objectFit: "cover",
